...
const FlowStartNode = () => {
  ...
  return (
    <div className="w-[200px] rounded-md border border-gray-200 relative bg-white shadow-lg">
      {/* Right Handle */}
      <Handle
        type="source"
        position={Position.Right}
        className="!pointer-events-auto w-3 h-3 bg-green-500"
      />

      {/* Header */}
      <div className="w-full flex rounded-md mb-1 relative shadow-lg">
        <div className="absolute h-full top-0 left-0 w-[7px] bg-green-500 rounded-l-md" />
        <div className="w-full flex items-center justify-between px-2 py-1 bg-white">
